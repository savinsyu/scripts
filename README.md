...
| clean_files.sh | Удаляет файлв в определенных папках |
| create_many_files.sh | Создает файл в нескольких папках |
| issue_number_commit.sh| СОтправляет коммит на репозиторий с указанием номера задачи|
